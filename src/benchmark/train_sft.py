...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SFT warm start on UltraFeedback Binarized.")
...
def main() -> None:
    ...
    model = AutoModelForCausalLM.from_pretrained(args.base_model, torch_dtype=pick_torch_dtype())
